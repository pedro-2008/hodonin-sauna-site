    ...
    <section id="pricing" ref={ref} className="py-32 px-6 relative overflow-hidden bg-gradient-pricing">
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        <div className={`text-center mb-20 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <h2 className="font-display text-5xl md:text-6xl lg:text-7xl font-medium elegant-underline inline-block" style={{ color: 'hsl(var(--pricing-heading))' }}>
            Ceník – Finská sauna
          </h2>
        </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="flex-1">
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    <h3 className="font-display text-3xl md:text-4xl font-medium mb-3" style={{ color: 'hsl(var(--pricing-heading))' }}>
                      Dárkové poukazy
                    </h3>
                    <p className="text-lg mb-4 font-light" style={{ color: 'hsl(var(--pricing-main-text))' }}>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <CardContent className="space-y-4">
              {[
                ...
                <div 
                  key={index}
                  className="flex items-center justify-between p-4 rounded-2xl bg-muted/30 hover:bg-muted/50 transition-all duration-300 group"
                >
          ...
          {/* Permanentky */}
          <Card 
            className={`luxury-card overflow-hidden border-0 relative transition-all duration-1000 hover-lift ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} 
          ...
          >
            ...
            <CardContent className="space-y-4">
              {[
                ...
                <div 
                  key={index}
                  className="flex items-center justify-between p-4 rounded-2xl bg-luxury-gold/5 hover:bg-luxury-gold/10 transition-all duration-300 border border-luxury-gold/10 group"
                >
                  <div className="flex items-center gap-3">
              ...
              <div className="flex items-start gap-3 pt-4 mt-4 border-t border-border/50">
                ...
                <p className="text-sm font-light" style={{ color: 'hsl(var(--pricing-main-text))' }}>

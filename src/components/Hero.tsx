    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-hero">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 mb-8 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 animate-fade-in">
          ...
          <span className="text-sm font-medium tracking-wider uppercase" style={{ color: 'hsl(var(--hero-accent-text))' }}>
            Finská sauna v Hodoníně
          </span>
        </div>
        
        {/* Main Heading with Display Font */}
        <h1 className="font-display text-6xl md:text-8xl font-medium mb-6 tracking-wide animate-fade-in" style={{ color: 'hsl(var(--hero-heading))' }}>
        ...
        <p className="text-xl md:text-2xl mb-4 font-light animate-fade-in-up tracking-wide" style={{ color: 'hsl(var(--hero-main-text))', animationDelay: '0.3s', animationFillMode: 'backwards' }}>
          Teplo • Klid • Regenerace
        </p>
        
        <p className="text-lg mb-12 max-w-2xl mx-auto animate-fade-in-up leading-relaxed" style={{ color: 'hsl(var(--hero-main-text))', opacity: 0.9, animationDelay: '0.4s', animationFillMode: 'backwards' }}>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up" style={{ animationDelay: '0.6s', animationFillMode: 'backwards' }}>
          <Button 
            size="lg" 
            className="text-lg px-10 py-6 bg-secondary text-wood-dark hover:bg-secondary/90 transition-all duration-300 hover:scale-105 hover:shadow-xl font-medium tracking-wide"
            onClick={() => {
          ...
          <Button 
            variant="outline" 
            size="lg" 
            className="text-lg px-10 py-6 bg-transparent border-white/30 hover:bg-white/10 hover:border-white/50 transition-all duration-300 hover:scale-105" 
